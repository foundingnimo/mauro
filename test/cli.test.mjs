...
test("init maps a monorepo and generates scoped Navigators", () => {
  ...
  assert.ok(initialized.next.some((item) => item.includes("Restart other open Claude Code sessions")));
...
test("map update keeps a human-approved capability that spans several units", () => {
  ...
  assert.match(regenerate.stdout, /Restart other open Claude Code sessions/);
